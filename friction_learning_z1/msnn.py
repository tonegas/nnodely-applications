from nnodely import nnodely, Input, Output, ParamFun, LocalModel, Fuzzify, Concatenate, Select, Integrate, TextVisualizer
...
WS                        = os.path.join(ROOT, 'cmame', "models", "msnn")
