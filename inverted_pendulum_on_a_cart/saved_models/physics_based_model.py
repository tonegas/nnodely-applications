...
class TracerModel(torch.nn.Module):
    def __init__(self):
        ...
        self.all_parameters["I"] = torch.nn.Parameter(torch.tensor([0.28874674439430237]), requires_grad=True)
        self.all_parameters["b"] = torch.nn.Parameter(torch.tensor([0.9734947085380554]), requires_grad=True)
        self.all_parameters["d"] = torch.nn.Parameter(torch.tensor([0.9259300827980042]), requires_grad=True)
        self.all_parameters["gear"] = torch.nn.Parameter(torch.tensor([92.63623809814453]), requires_grad=True)
        self.all_parameters["l"] = torch.nn.Parameter(torch.tensor([0.2183452993631363]), requires_grad=True)
        self.all_parameters["m1"] = torch.nn.Parameter(torch.tensor([7.965378284454346]), requires_grad=True)
        self.all_parameters["m2"] = torch.nn.Parameter(torch.tensor([6.387969970703125]), requires_grad=True)
