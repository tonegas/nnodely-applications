...
class TracerModel(torch.nn.Module):
    def __init__(self):
        ...
        self.all_parameters["a1"] = torch.nn.Parameter(torch.tensor([0.021709894761443138]), requires_grad=True)
        self.all_parameters["a10"] = torch.nn.Parameter(torch.tensor([0.5258023142814636]), requires_grad=True)
        self.all_parameters["a11"] = torch.nn.Parameter(torch.tensor([0.03575937822461128]), requires_grad=True)
        self.all_parameters["a12"] = torch.nn.Parameter(torch.tensor([3.3914072513580322]), requires_grad=True)
        self.all_parameters["a13"] = torch.nn.Parameter(torch.tensor([0.22385646402835846]), requires_grad=True)
        self.all_parameters["a14"] = torch.nn.Parameter(torch.tensor([0.22628794610500336]), requires_grad=True)
        self.all_parameters["a2"] = torch.nn.Parameter(torch.tensor([0.014598706737160683]), requires_grad=True)
        self.all_parameters["a4"] = torch.nn.Parameter(torch.tensor([0.05111302062869072]), requires_grad=True)
        self.all_parameters["a5"] = torch.nn.Parameter(torch.tensor([0.034060195088386536]), requires_grad=True)
        self.all_parameters["a6"] = torch.nn.Parameter(torch.tensor([1.4442225694656372]), requires_grad=True)
        self.all_parameters["a7"] = torch.nn.Parameter(torch.tensor([0.05105852335691452]), requires_grad=True)
        self.all_parameters["a8"] = torch.nn.Parameter(torch.tensor([0.34952136874198914]), requires_grad=True)
